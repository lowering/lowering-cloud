...
public class OAuth2SsoSecurityConfigurer {
    ...
    public OAuth2SsoSecurityConfigurer(ApplicationContext applicationContext) {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http.apply(new OAuth2SsoSecurityConfigurer.OAuth2ClientAuthenticationConfigurer(oauth2SsoFilter(sso)));
